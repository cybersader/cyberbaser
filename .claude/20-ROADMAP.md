...
- [ ] Decide the operating model for a maintainer who does not use GitHub: hosted, one-click self-hosted, or local-first. Owner self-dogfooding tests one local workflow but does not choose the general product model. The 2026-08-11 option pass preserves Iroh as the strongest proposal-transport fixture candidate and AT Protocol as an optional public identity/signed-record/carrier/discovery spoke; it authorizes no experiment and selects no substrate.
