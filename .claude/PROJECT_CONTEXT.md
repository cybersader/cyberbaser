...
> Last aligned: 2026-08-10 (WP1 implemented and hermetically tested; live installation pending. WP2 implemented and mechanically accepted. WP3 phase one completed its container-isolated real Forgejo 16.0.2 gate. WP4's shared contract, Lane A adapter, local queue, Lane B adapter/app, disabled renderer form, and sibling-service deployment bundle are implemented and mechanically tested at their stated layers; offered-lane and human evidence remain next). If this file disagrees with the docs site, the docs site wins, and this file should be fixed in the same session.
