...
<div class="cb-triangle-wrapper" role="img" aria-label="Triangle showing the three forces that cyberbaser has to satisfy simultaneously">
  ...
  <p class="cb-triangle-caption">
    Every existing Obsidian-to-web tool sits on an <em>edge</em>, not in the middle. Cyberbaser's thesis is that with the right translation layer, you can occupy the interior.
  </p>
</div>
